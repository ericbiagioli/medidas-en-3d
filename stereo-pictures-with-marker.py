...
def capture_images(calib="stereo_charuco_calibration.npz",
    ...
    while True:
        ...
        cv2.putText(vis_L, f"a = {saved_a}", (50, 50),
            cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,0), 2)
        cv2.putText(vis_L, f"b = {saved_b}", (50, 100),
            cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,0), 2)
        cv2.putText(vis_L, f"c = {saved_c}", (50, 150),
            cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255,255,0), 2)
        ...
        if center_float_L is not None and center_float_R is not None and center_float_L_rect is not None and center_float_R_rect is not None:
                cansave = True
